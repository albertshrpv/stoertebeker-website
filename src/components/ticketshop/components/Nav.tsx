...
const componentContentPadding = "px-6 md:px-16 xl:px-20";

const LanguageSwitch = ({ currentLocale, onClick }: { currentLocale: string; onClick?: () => void }) => {
    const redirectTo = (locale: string) => {
        window.location.href = `/${locale}/shop`;
    }

    const handleClick = () => {
        redirectTo(currentLocale === 'de' ? 'en' : 'de');
        if (onClick) onClick();
    }
    ...
    return (
        <div
            onClick={handleClick}
            className="flex w-11 h-11 font-semibold rounded-full border-2 border-darkBlue hover:text-white hover:bg-darkBlue hover:cursor-pointer transition-all duration-300 ease-in-out items-center justify-center gap-20 relative z-[200]"
        >
...
export default function Nav({ locale }: NavProps) {
    ...
    const contactLink = locale === 'de' ? '/de/kontakt' : '/en/contact';
    ...
    return (
        <>
            <header className="top-0 z-[100]">
                <nav className={`block z-[100] relative lg:flex justify-start w-full h-[100px] lg:h-[134px] bg-white`}>
                    <div className="max-w-[2000px] h-full w-full mx-auto relative">
                        <div className={`mx-auto h-full w-full flex items-center justify-between relative ${componentContentPadding}`}>
                            <div className="flex items-center justify-center gap-20 relative z-[200]">
                                <a href={`/${locale}/shop`} aria-label="Logo" className="flex items-center justify-start">
                                    <svg className='w-[100px] lg:w-[148px]' id="Ebene_1" xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 595.3 317.5">
                                        <g id="Logos-NEU">
                                            <g className="st0">
                                                <g className="st0">
                            ...
                            <div className="flex items-center justify-end gap-6 font-medium text-lg">
                                <a href="https://www.stoertebeker.de" target="_blank" className="text-darkBlue px-8 hidden lg:block">
                                    Störtebeker Festspiele
                                </a>
                                <a href={`/${locale}/shop`} className="text-darkBlue pr-8 hidden lg:block">
                                    Tickets kaufen
                                </a>
                                {/* <button
                                    onClick={() => {
                                    ...
                                    className="text-darkBlue font-semibold pr-8 hidden lg:block"
                                >
                                    GUTSCHEINE
                                </button> */}
                                <a href={`${contactLink}`} className="text-darkBlue pr-8 hidden lg:block">
                                    Kontakt
                                </a>
                                {/* Account button */}
                                <button
                                    onClick={() => setIsAccountModalOpen(true)}
                                    className="flex w-11 h-11 rounded-full border-2 border-darkBlue bg-white hover:bg-darkBlue hover:cursor-pointer transition-all duration-300 ease-in-out items-center justify-center gap-20 relative z-[200] p-2 group"
                                    aria-label="Account"
                                >
                                    {/* <svg width="15" height="16" viewBox="0 0 15 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M13.3399 14.8342C13.3399 12.6976 10.5686 10.9655 7.14994 10.9655C3.73131 10.9655 0.959961 12.6976 0.959961 14.8342M7.14994 8.64422C5.0133 8.64422 3.2812 6.91212 3.2812 4.77548C3.2812 2.63883 5.0133 0.906738 7.14994 0.906738C9.28659 0.906738 11.0187 2.63883 11.0187 4.77548C11.0187 6.91212 9.28659 8.64422 7.14994 8.64422Z" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                    </svg> */}
                                    <svg className="w-4 stroke-darkBlue group-hover:stroke-white transition-colors duration-300" viewBox="0 0 12 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <button
                                    ...
                                    className="relative block focus:outline-none z-[100] overflow-visible lg:hidden"
                                    aria-label="Burger Menu"
                                >
                                    <div className="space-y-2 flex flex-col items-end">
                                        <div className={`w-8 h-0.5 bg-neutral-900 transition-all duration-300 ease-in-out ${isMobileMenuOpen ? 'rotate-45 translate-y-[10px]' : ''}`}></div>
                                        <div className={`w-8 h-0.5 bg-neutral-900 transition-all duration-300 ease-in-out ${isMobileMenuOpen ? 'opacity-0' : ''}`}></div>
                                        <div className={`w-8 h-0.5 bg-neutral-900 transition-all duration-300 ease-in-out ${isMobileMenuOpen ? '-rotate-45 -translate-y-[10px]' : ''}`}></div>
                                    </div>
                                </button>
                            </div>
                ...
                {/* Mobile Menu */}
                <div
                    className={`fixed top-[100px] right-0 h-[calc(100vh-100px)] w-full z-[50] bg-white text-black transform transition-transform duration-500 ease-in-out lg:hidden overflow-y-auto ${isMobileMenuOpen ? 'translate-x-0' : 'translate-x-full'
                        }`}
                >
                    <div className="flex flex-col justify-between h-full">
                        {/* Language Switch */}
                        {/* <div className="pt-8 flex justify-center">
                            <LanguageSwitch currentLocale={locale} onClick={closeMobileMenu} />
                        </div> */}

                        {/* Menu Items */}
                        <div className="flex flex-col justify-start items-start p-6 text-2xl font-medium mt-0">
                            <a
                                href={`/${locale}/shop`}
                                className="flex w-full items-center justify-between gap-2 transition-colors duration-300 border-b border-b-black py-12"
                            ...
                            >
                                ...
                                <span>
                                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M20.4493 12.3471L20.5447 0.700673L14.5828 6.6932C16.7441 4.52059 20.453 6.05248 20.4512 9.11707L20.4493 12.3471Z" fill="black" />
                                        <path d="M20.5447 0.700673L12.7804 0.764296L8.89826 0.796111L12.1092 0.781421C15.2011 0.767275 16.7634 4.50127 14.5828 6.6932L20.5447 0.700673Z" fill="black" />
                                        <path d="M0.715964 20.56L14.5828 6.6932M20.5447 0.700673L12.7804 0.764297L8.89826 0.796111M20.5447 0.700673L20.4493 12.3471M20.5447 0.700673L14.5828 6.6932M5.01612 0.827923L8.89826 0.796111M20.4175 16.2293L20.4493 12.3471M8.89826 0.796111L12.1092 0.781421C15.2011 0.767275 16.7634 4.50127 14.5828 6.6932M20.4493 12.3471L20.4512 9.11707C20.453 6.05248 16.7441 4.52059 14.5828 6.6932" stroke="black" stroke-width="1.33852" stroke-linecap="round" stroke-linejoin="round" />
                                    </svg>
                                </span>
                            </a>
                            <a
